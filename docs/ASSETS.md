...
The repository does not commit `tools/qemu/`. If you redistribute QEMU binaries in a Release, you must comply with QEMU and dependency licenses, including source-code availability requirements where applicable.
